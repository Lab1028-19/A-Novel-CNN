...
#                         scope='conv_input', bn_decay=bn_decay)
    ...
    convtp_2p = tf_util.conv2d_transpose(res_2,32,[2,3],
                                       padding='SAME', stride=[1,1],
                                       bn=True, is_training=is_training,
    ...
    convtp_4p = tf_util.conv2d_transpose(res_4,64,[8,12],
                                       padding='SAME', stride=[1,1],
                                       bn=True, is_training=is_training,
    ...
    net = tf_util.conv2d(net, 512, [4,6],
                         padding='SAME', stride=[1,1],
                         bn=True, is_training=is_training,
    ...
    convtp_5 = tf_util.conv2d_transpose(dp_net5,128,[14,18],
                                       padding='SAME', stride=[1,1],
                                       bn=True, is_training=is_training,
